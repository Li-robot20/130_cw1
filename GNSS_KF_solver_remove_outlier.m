function [Xk_new, Pk_new, outlier] = GNSS_KF_solver_remove_outlier(X0, P0, time, sate_index, pseudo_range, pseudo_range_rate, detected_outlier) 
% Inputs:
%   X0                  State vector
%   P0                  Error covariance
...
v = (Hk*inv(Hk.'*Hk)*Hk.'-eye(16))*z;

% Compute the residuals covariance matrix
rho_p = 5;
Cv = (eye(16)-Hk*inv(Hk.'*Hk)*Hk.')*rho_p^2;
